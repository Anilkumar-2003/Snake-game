...
class Game extends JPanel {
    ...
    private static Font FONT_M = new Font("MV Boli", Font.PLAIN, 25);
    private static Font FONT_M_ITALIC = new Font("MV Boli", Font.ITALIC, 24);
    private static Font FONT_L = new Font("MV Boli", Font.PLAIN, 65);
    ...
    private void render(Graphics g) {
        ...
        g2d.setFont(FONT_M_ITALIC);

        if (status == GameStatus.NOT_STARTED) {
          drawCenteredString(g2d, "SNAKE", FONT_XL, 200);
          drawCenteredString(g2d, "GAME", FONT_L, 300);
          drawCenteredString(g2d, "Press  any  Enter to  begin: ", FONT_M_ITALIC, 330);
        ...
        if (status == GameStatus.GAME_OVER) {
            ...
            drawCenteredString(g2d, "GAME OVER", FONT_L, 200);
        }
